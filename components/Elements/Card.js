  ...
  return (
    <div className="max-w-sm mx-8 my-8 overflow-hidden rounded-xl bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl">
      ...
      <div className="p-6">
        ...
        <a href={github} className="w-1/4 mt-1 mb-1 p-8 rounded-md bg-gray-800  py-2 text-indigo-100 hover:bg-gray-600 hover:shadow-md duration-75">
          <GitHubIcon />          
        </a>
        <a href={deploy}className="w-1/4 mt-1 mb-1 p-8 rounded-md bg-gray-800  py-2 text-indigo-100 hover:bg-gray-600 hover:shadow-md duration-75">
         <LinkIcon /> 
        </a>
        </div>
      </div>
